...
public class UserProcess {
	...
	if (Processor.pageFromAddress(vaddr) < 0 || Processor.pageFromAddress(vaddr) >= numPages) return -1;	
	int amount = 0;
	...
	*/
	...
	while (length > 0) {
	    ...
	    if (actual == -1) return -1; // add a line here to handle invalid vaddrBuffer value
