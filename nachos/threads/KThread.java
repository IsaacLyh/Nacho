...
public class KThread {
	...
	public static void finish() {
		...
		ThreadQueue current_Threads = null;
		if(currentThread.joinQueue != null){
			current_Threads = currentThread.joinQueue;
		}
		else{
			Lib.debug(dbgThread, "JoingQueue is Empty!");			
		}

    	if (current_Threads != null) {
        	KThread next = current_Threads.nextThread();
        	while(next != null) {
            	next.ready();
           	 	next = current_Threads.nextThread();
        	}
    	}
	...
	public void join() {
		...
		Lib.assertTrue(this != currentThread);
        boolean curr_Status = Machine.interrupt().disable();
    	
    	if (joinQueue == null) {
    		if(this != currentThread){ 
            	joinQueue = ThreadedKernel.scheduler.newThreadQueue(true);
            	Lib.debug(dbgThread,"Initializing new ThreadQueue and acquire:" + toString());  
    	...
    	if (currentThread != this) {
    		if(status != statusFinished){
        		...
        		Lib.debug(dbgThread,"Waiting for access: "+ toString());   
        		currentThread.sleep();
        	}
    	}

		Machine.interrupt().restore(curr_Status);
	}
	...
	public static void selfTest() {
		...
		System.out.println("in KThread.selfTest");
		...
		System.out.println("finish test in KThread");
	}
